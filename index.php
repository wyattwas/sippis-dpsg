...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="rosskur2026/index.php">Rosskur 2026</a>
            </li>
            <li class="nav-item">
...
<div class="content">
    <div class="page">
        ...
        <p>
            <a href="https://www.instagram.com/p/DO75XWwAir-/"
               class="link-button text-white bg-danger">Instagram
                Post</a>
        </p>
        <p>
            <img src="assets/rosskur_gewonnen.jpg" alt="Wir sind Gewinner!"
    ...
    <div class="page page-canada">
        ...
        <p>
            ...
            Telefon: <a class="text-danger" href="tel:+4917655233953">+49 176 55233953</a>
        </p>
        <p>
            <a href="canada.php"
    ...
    <div class="page page-canada">
        ...
        <p>
            ...
            Unser Ziel ist Kanada. Da wir dafür noch jede Menge finanzielle Unterstützung benötigen,
            bieten wir unsere Hilfe an.<br>
            Wir können für euch Aufgaben übernehmen und würden uns über eine Spende freuen.
            Z.B. Gartenarbeit, Einkäufe, Hilfe beim Umzug, Computerhilfe, oder Ähnliches<br>
        </p>
        <p>
            <img src="assets/Rover-auf-großer-Fahrt.png" alt="Rover auf großer Fahrt"
                 class="w-100 border-radius-8 gray-border">
        </p>
    </div>
    <div class="page">
